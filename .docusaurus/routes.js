        ...
        routes: [
          {
            ...
            routes: [
              {
                path: '/category/-api-netic',
                component: ComponentCreator('/category/-api-netic', '887'),
                exact: true,
              ...
              {
                path: '/netic/api/cles',
                component: ComponentCreator('/netic/api/cles', 'd04'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/netic/api/erreurs',
                component: ComponentCreator('/netic/api/erreurs', '359'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/netic/api/exemples',
                component: ComponentCreator('/netic/api/exemples', 'f18'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/netic/api/intro',
                component: ComponentCreator('/netic/api/intro', '78c'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/netic/api/v1',
                component: ComponentCreator('/netic/api/v1', 'b7d'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/netic/api/v2',
                component: ComponentCreator('/netic/api/v2', 'efc'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
